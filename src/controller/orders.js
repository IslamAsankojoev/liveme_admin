import {
    ...
    ReferenceField,
    ReferenceInput, DeleteButton, useRedirect
} from 'react-admin';
...
export const OrderEdit = () => {
    ...
    return (
        <Edit>
            <SimpleForm onSubmit={(data) => { CustomCreateUpdate(location, data, redirect, '/orders', id) }}>
                <TextInput source="id" />
                ...
                <br />
                <SelectInput source="order_time" label={'delivery time'} defaultValue={'take 3 hours'} choices={[
                ...
                <RadioButtonGroupInput source="payment_method" choices={[
                    { id: 'Cash', name: 'Cash' },
                    { id: 'Bank', name: 'Bank' },
                    { id: 'Card', name: 'Card' },
                ]} />
                <SelectInput source="order_status" choices={[
